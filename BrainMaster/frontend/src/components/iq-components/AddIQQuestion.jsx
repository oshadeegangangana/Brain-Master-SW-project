...
class AddIqQuestion extends Component {
    constructor(props) {
        super(props);
        this.state = {
            paper_id: null,
    ...
    componentDidMount() {
        ...
        fetch(api + "/paper2/" + sessionStorage.getItem("added_paper_id:"), {
            method: "post",
            headers: {
                                ...
                                >
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <div className="form-group" hidden={this.state.question_type=="structured"}>
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <div className="form-group" >
                                                ...
                                                <input
                                                    type="text"
                                                    className="form-control style-input text-uppercase"
                                                    placeholder="Option 4"
                                                    name="question_type"
                                                    onChange={(event) => {
