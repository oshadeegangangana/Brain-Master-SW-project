...
class InstructionsIqExam extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selected_paper: null,
    ...
    render() {
        ...
        if (!isLoaded) {
            return (
                <div>
                    <h4 className="header-title">IQ Paper Instructions</h4>
                    Loading...
                </div>
            );
        } else {
                ...
                <div>
                    ...
                    <div className="card text-center text-white bg-dark">
                        <div className="card-header">
                            Welcome to Online Exam for IQ test.
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6">
                                    <div className="card bg-danger">
                                        <div className="card-body">
                                            <h5 className="card-title">IQ Paper Instructions</h5>
                                            <p className="card-text text-white" >
                                                <div style={{ textAlign: "left"}}>
                                                    - The Exam has 5 multiple-choice questions (MCQ) <br/>
                                                    - And 5 structured questions (MCQ). <br/>
                                                    ...
                                                    - Paper Type : <span className="text-uppercase">{selected_paper.paper_type}</span> - MCQ & Structured<br/>
                                                </div>
                                            </p>
                                            <button
                                                style={{
                                            ...
                                            >
                                                <a href="/iq_exam" className="btn btn-primary">
...
export default InstructionsIqExam;