...
class GkExam extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selected_paper: null,
    ...
    componentDidMount() {
        //MARK: set paper details, questions array, active user
    ...
    submitExam() {
        ...
        window.sessionStorage.setItem("gkExamMarking:", JSON.stringify(marking));
            ...
            this.updateGrade().then(r => {
                ...
                fetch(api + "/exam", {
                    ...
                    this.updateTotalMarks().then(r => {
                        ...
                        this.setState({redirect: "/gk_result"});
    ...
    render() {
        ...
        let {isLoaded, questions, selected_paper, participant_user} = this.state;
        if (!isLoaded) {
            return (
                <div>
            ...
            return (
                <div>
                    <ToastContainer/>
                    <br/>
                    <h5> General Knowledge Exam : {selected_paper.paper_name}</h5>
                    <br/>
                    <p className="card-text">
                        Participant : <b>{participant_user.f_name + " " + participant_user.l_name}</b> &emsp;&emsp;&emsp;&emsp;
