...
class GkExamResult extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selected_paper: null,
    ...
    componentDidMount() {
        ...
        const marking = sessionStorage.getItem("gkExamMarking:");
    ...
    backHome() {
        window.sessionStorage.setItem("selectedGkPaperID:", null);
        window.sessionStorage.setItem("gkExamMarking:", null);
        this.setState({
            redirect: "/",
        })
                        ...
                        <div className="col-lg-12 ">
                            <div className="card text-center text-white bg-dark">
                                <div className="card-body">
                                    <h4 className="header-title text-white">General Knowledge Exam Summery</h4>
                                    <div className="card-body">
                                        <div className="row">
